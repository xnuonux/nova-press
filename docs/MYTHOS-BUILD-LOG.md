...
- current fire: **phase 2.1** ... the editorial brain begins: `v0_8_0_np_editorial.sql` (stage + passes) + fix the `PieceStatus` drift.
- the suite: 432 tests green.
